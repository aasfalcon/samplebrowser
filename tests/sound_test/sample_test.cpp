...
TEST(SoundSampleTest, ctor)
{
    ...
    NO_THROW(Sample<Int64> s(MAX_INT64));
    ...
    NO_THROW(Sample<Int64> s(MIN_INT64));
...
TEST(SoundSampleTest, ctorValue)
{
    ...
    NO_THROW(Sample<Int64> i64Max(MAX_INT64));
    NO_THROW(Sample<Int64> i64Min(MIN_INT64));
    NO_THROW(Sample<Int64> i64Nil(NIL_INT64));
...
TEST(SoundSampleTest, ctorCopy)
{
    ...
    EQ(f32s1.value(), MAX_FLOAT32);
    EQ(f32s2.value(), MIN_FLOAT32);
    EQ(f32s3.value(), NIL_FLOAT32);
    ...
    EQ(f64s1.value(), MAX_FLOAT64);
    EQ(f64s2.value(), MIN_FLOAT64);
    EQ(f64s3.value(), NIL_FLOAT64);
    ...
    EQ(i8s1.value(), MAX_INT8);
    EQ(i8s2.value(), MIN_INT8);
    EQ(i8s3.value(), NIL_INT8);
    ...
    EQ(i16s1.value(), MAX_INT16);
    EQ(i16s2.value(), MIN_INT16);
    EQ(i16s3.value(), NIL_INT16);

    Sample<Int64> i64Max(MAX_INT64);
    Sample<Int64> i64Min(MIN_INT64);
    Sample<Int64> i64Nil(NIL_INT64);
    Sample<Int64> i64s1(i64Max);
    Sample<Int64> i64s2(i64Min);
    Sample<Int64> i64s3(i64Nil);
    EQ(i64s1.value(), MAX_INT64);
    EQ(i64s2.value(), MIN_INT64);
    EQ(i64s3.value(), NIL_INT64);
    ...
    EQ(i32s1.value(), MAX_INT32);
    EQ(i32s2.value(), MIN_INT32);
    EQ(i32s3.value(), NIL_INT32);
}
...
TEST(SoundSampleTest, ctorConvert)
{
    ...
    Sample<Float32> f32_from_i64Max(i64Max);
    ...
    EQ(f32_from_i64Max.value(), MAX_FLOAT32);
    ...
    Sample<Float32> f32_from_i64Min(i64Min);
    ...
    EQ(f32_from_i64Min.value(), MIN_FLOAT32);
    ...
    Sample<Float32> f32_from_i64Nil(i64Nil);
    ...
    EQ(f32_from_i64Nil.value(), NIL_FLOAT32);
    ...
    Sample<Float64> f64_from_i64Max(i64Max);
    ...
    EQ(f64_from_i64Max.value(), MAX_FLOAT64);
    ...
    Sample<Float64> f64_from_i64Min(i64Min);
    ...
    EQ(f64_from_i64Min.value(), MIN_FLOAT64);
    ...
    Sample<Float64> f64_from_i64Nil(i64Nil);
    ...
    EQ(f64_from_i64Nil.value(), NIL_FLOAT64);
    ...
    for (int i = 0; i < CYCLES; i++) {
        ...
        Sample<Int8> i8_from_i64Max(i64Max);
        ...
        NEAR(i8_from_i64Max.value(), MAX_INT8, LSB_ERROR);
        ...
        Sample<Int8> i8_from_i64Min(i64Min);
        ...
        NEAR(i8_from_i64Min.value(), MIN_INT8, LSB_ERROR);
        ...
        Sample<Int8> i8_from_i64Nil(i64Nil);
        ...
        NEAR(i8_from_i64Nil.value(), NIL_INT8, LSB_ERROR);
        ...
        Sample<Int16> i16_from_i64Max(i64Max);
        ...
        NEAR(i16_from_i64Max.value(), MAX_INT16, LSB_ERROR);
        ...
        Sample<Int16> i16_from_i64Min(i64Min);
        ...
        NEAR(i16_from_i64Min.value(), MIN_INT16, LSB_ERROR);
        ...
        Sample<Int16> i16_from_i64Nil(i64Nil);
        ...
        NEAR(i16_from_i64Nil.value(), NIL_INT16, LSB_ERROR);
        ...
        Sample<Int32> i32_from_i64Max(i64Max);
        ...
        NEAR(i32_from_i64Max.value(), MAX_INT32, LSB_ERROR);
        ...
        Sample<Int32> i32_from_i64Min(i64Min);
        ...
        NEAR(i32_from_i64Min.value(), MIN_INT32, LSB_ERROR);
        ...
        Sample<Int32> i32_from_i64Nil(i64Nil);
        ...
        NEAR(i32_from_i64Nil.value(), NIL_INT32, LSB_ERROR);
...
TEST(SoundSampleTest, value)
{
    ...
    Sample<Float32> f32Min(MIN_FLOAT32);
    Sample<Float32> f32Nil(NIL_FLOAT32);
    EQ(f32Max.value(), MAX_FLOAT32);
    EQ(f32Min.value(), MIN_FLOAT32);
    EQ(f32Nil.value(), NIL_FLOAT32);

    Sample<Float64> f64Max(MAX_FLOAT64);
    Sample<Float64> f64Min(MIN_FLOAT64);
    Sample<Float64> f64Nil(NIL_FLOAT64);
    EQ(f64Max.value(), MAX_FLOAT64);
    EQ(f64Min.value(), MIN_FLOAT64);
    EQ(f64Nil.value(), NIL_FLOAT64);

    Sample<Int8> i8Max(MAX_INT8);
    Sample<Int8> i8Min(MIN_INT8);
    Sample<Int8> i8Nil(NIL_INT8);
    EQ(i8Max.value(), MAX_INT8);
    EQ(i8Min.value(), MIN_INT8);
    EQ(i8Nil.value(), NIL_INT8);

    Sample<Int16> i16Max(MAX_INT16);
    Sample<Int16> i16Min(MIN_INT16);
    Sample<Int16> i16Nil(NIL_INT16);
    EQ(i16Max.value(), MAX_INT16);
    EQ(i16Min.value(), MIN_INT16);
    EQ(i16Nil.value(), NIL_INT16);

    Sample<Int64> i64Max(MAX_INT64);
    Sample<Int64> i64Min(MIN_INT64);
    Sample<Int64> i64Nil(NIL_INT64);
    EQ(i64Max.value(), MAX_INT64);
    EQ(i64Min.value(), MIN_INT64);
    EQ(i64Nil.value(), NIL_INT64);

    Sample<Int32> i32Max(MAX_INT32);
    Sample<Int32> i32Min(MIN_INT32);
    Sample<Int32> i32Nil(NIL_INT32);
    EQ(i32Max.value(), MAX_INT32);
    EQ(i32Min.value(), MIN_INT32);
    EQ(i32Nil.value(), NIL_INT32);
}

TEST(SoundSampleTest, silence)
{
    Sample<Float32> f32(1);
    Sample<Float64> f64(1./2);
    Sample<Int8> i8(3);
    Sample<Int16> i16(4);
    Sample<Int64> i64(5);
    Sample<Int32> i32(6);
    ...
    EQ(f32.value(), NIL_FLOAT32);
    EQ(f64.value(), NIL_FLOAT64);
    EQ(i8.value(), NIL_INT8);
    EQ(i16.value(), NIL_INT16);
    EQ(i64.value(), NIL_INT64);
    EQ(i32.value(), NIL_INT32);
}

...
#define SOUND_INHERITED_ENUM(a_ns, a_scope, a_base, ...) \
    namespace a_ns {                                     \
...
#define SOUND_PROCESSOR_COMMANDS(a_scope, a_base, ...) \
    SOUND_INHERITED_ENUM(Command, a_scope, a_base, __VA_ARGS__)

#define SOUND_PROCESSOR_PROPERTIES(a_scope, a_base, ...) \
    SOUND_INHERITED_ENUM(Property, a_scope, a_base, __VA_ARGS__)

...
template <>
inline constexpr Precise Object<Precise>::min() { return MIN_PRECISE; }
#endif
...
template <>
inline constexpr Type Object<Precise>::type() { return Type::Precise; }
}
